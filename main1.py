...
KEYWORDS_ELECTRONICS = [
    ...
    "วงจร", "electronic", "electronics", "circuit", "อาคาร 12", "ตึก 12", "12"
]
KEYWORDS_CONSTRUCTION = [
    "ช่างก่อสร้าง", "ก่อสร้าง", "ตึกก่อสร้าง", "แผนกก่อสร้าง", "construction", "civil works", "อาคาร 2", "ตึก 2", "2"
]
KEYWORDS_CIVIL = [
    "ช่างโยธา", "โยธา", "แผนกโยธา", "ตึกโยธา", "civil", "civil engineer", "อาคาร 2", "ตึก 2", "2"
]
KEYWORDS_FURNITURE = [
    "ช่างเฟอร์นิเจอร์", "ตกแต่งภายใน", "เฟอร์นิเจอร์", "ออกแบบภายใน", "อินทีเรีย", 
    "furniture", "interior", "design", "wood work", "งานไม้", "อาคาร 13", "ตึก 13", "13"
]
KEYWORDS_SURVEY = [
    "ช่างสำรวจ", "สำรวจ", "แผนกสำรวจ", "ตึกสำรวจ", "survey", "land survey", "อาคาร 3", "ตึก 3", "3"
]
KEYWORDS_ARCHITECT = [
    "สถาปัตยกรรม", "สถาปัตย์", "สถาปัต", "แผนกสถาปัตย์", "ตึกสถาปัตย์", "architect", "architecture", "ออกแบบบ้าน"
]
KEYWORDS_AUTO = [
    "ช่างยนต์", "ยนต์", "ยานยนต์", "เครื่องยนต์", "แผนกช่างยนต์", "ตึกช่างยนต์", "อาคาร 6", "ตึก 6", "6",
    "ซ่อมรถ", "garage", "auto", "mechanic", "automotive"
]
KEYWORDS_FACTORY = [
    "ช่างกลโรงงาน", "กลโรงงาน", "โรงงาน", "ช่างกล", "แผนกกลโรงงาน", "machine", "factory", "machinist","เครื่องกล","เครื่องกลโรงงาน", "อาคาร 4", "ตึก 4", "4"
]
KEYWORDS_WELDING = [
    "ช่างเชื่อมโลหะ", "เชื่อมโลหะ", "เชื่อม", "ช่างเชื่อม", "แผนกเชื่อม", "welding", "metal work", "อาคาร 7", "ตึก 7", "7"
]
KEYWORDS_BASICTECH = [
    "ช่างเทคนิคพื้นฐาน", "เทคนิคพื้นฐาน", "พื้นฐานช่าง", "ตึกพื้นฐาน", "basic tech", "workshop"
]
KEYWORDS_ELECTRIC = [
    "ช่างไฟฟ้า", "ไฟฟ้า", "ไฟฟ้ากำลัง", "ไฟ", "แผนกไฟฟ้า", "ตึกไฟฟ้า", "electric", "electrical", "power" , "อาคาร 2", "ตึก 2", "2"
]
KEYWORDS_AIRCOND = [
    "เครื่องทำความเย็น", "ปรับอากาศ", "แอร์", "ช่างแอร์", "ระบบความเย็น", "ทำความเย็น", 
    "air condition", "refrigeration", "cool", "อาคาร 11", "ตึก 11", "11"
]
KEYWORDS_IT = [
    "เทคโนโลยีสารสนเทศ", "ไอที", "สารสนเทศ", "ข้อมูล", "it", "information technology", "programmer", "network", "อาคาร 4", "ตึก 4"
]
KEYWORDS_PETROLEUM = [
    "เทคโนโลยีปิโตรเลียม", "ปิโตรเลียม", "ปิโตร", "น้ำมัน", "แท่นขุดเจาะ", "petroleum", "oil", "gas", "offshore", "อาคาร 9", "ตึก 9", "9"
]
KEYWORDS_ENERGY = [
    "เทคนิคพลังงาน", "พลังงาน", "ทดแทน", "โซลาร์เซลล์", "energy", "solar", "power plant", "อาคาร 8", "ตึก 8", "8"
]
KEYWORDS_LOGISTICS = [
    "โลจิสติกส์", "ซัพพลายเชน", "ขนส่ง", "logistics", "shipping", "supply chain","โลจิส", "อาคาร 14", "ตึก 14", "14"
]
KEYWORDS_RAIL = [
    "ระบบขนส่งทางราง", "ขนส่งทางราง", "ราง", "ระบบราง", "รถไฟ", "ช่างรถไฟ", "rail", "railway", "train", "อาคาร 5", "ตึก 5", "5"
]
KEYWORDS_MECHATRONICS = [
    "เมคคาทรอนิกส์", "เมคคา", "แม็กคา", "แมคคา", "หุ่นยนต์", "robot", "mechatronics", "automation", "แขนกล", "อาคาร 8", "ตึก 8", "8"
]
KEYWORDS_AIRLINE = [
    "แผนกการบิน", "การบิน", "ธุรกิจการบิน", "แอร์ไลน์", "สนามบิน", "aviation", "airline", "airport", "อาคาร 14", "ตึก 14", "14"
]
KEYWORDS_COMPUTER_TECH = [
    "เทคโนโลยีคอมพิวเตอร์", "เทคโนโลยีคอม", "คอมพิวเตอร์", "คอมพิว", "ตึกส้ม", "ช่างคอม", 
    "computer tech", "hardware", "computer", "อาคาร 15", "ตึก 15", "15"
]
KEYWORDS_BASIC_SUBJECTS = [
    "วิชาพื้นฐาน", "พื้นฐาน", "วิชาสามัญ", "คณิตศาสตร์", "ภาษาไทย", "ภาษาอังกฤษ", "วิทย์", "สังคม", 
    "math", "science", "english", "thai", "general subjects", "อาคาร 10", "ตึก 10", "10"
]
KEYWORDS_SOUTHERN_CENTER = [
    "ศูนย์ส่งเสริม", "อาชีวศึกษาภาคใต้", "ส่งเสริม", "ภาคใต้", "southern center", "อาคาร 23", "ตึก 23", "23"
]
KEYWORDS_60YEARS = [
    "ตึก 60 ปี", "60 ปี", "อาคาร 60 ปี", "อาคารเฉลิมพระเกียรติ", "60th anniversary building", "60"
]
KEYWORDS_TUK11 = [
    "ตึก 14", "อาคาร 14", "ตึกใหม่", "building 14", "ตึกหน้าแผนกอิเล็กทรอนิกส์"
]
# [NEW] เพิ่มอาคาร 10
KEYWORDS_TUK10 = [
...
KEYWORDS_COOP_SHOP = [
    "ร้านค้าสวัสดิการ", "สวัสดิการ", "ร้านค้า", "สหกรณ์", "coop", "shop", "อาคาร 16", "ตึก 16", "16"
]
KEYWORDS_CANTEEN1 = [
    "โรงอาหาร 1", "โรงอาหารหนึ่ง", "โรงอาหาร1", "แคนทีน 1", "กินข้าว 1", "อาคาร 18", "ตึก 18", "โรงอาหารเก่า", "18"
]
KEYWORDS_CANTEEN2 = [
    "โรงอาหาร 2", "โรงอาหารสอง", "โรงอาหาร2", "แคนทีน 2", "กินข้าว 2", "อาคาร 17", "ตึก 17", "โรงอาหารใหม่", "17"
]
KEYWORDS_BUILDING2 = [
    "อาคาร 19", "ตึก 19", "building 19", "19"
]
KEYWORDS_BUILDING3 = [
    "อาคาร 20", "ตึก 20", "building 20", "20"
]
KEYWORDS_LIBRARY = [
    "ห้องสมุด", "อ่านหนังสือ", "ยืมหนังสือ", "library", "book", "reading room", "อาคาร60พรรษามหาราชินี", "อาคาร60พรรษา", "อาคาร 21", "ตึก 21", "21"
]

KEYWORDS_GYM = [
    "โรงยิม", "ยิม", "ออกกำลังกาย", "gym", "sport hall", "อาคาร 22", "ตึก 22", "22"
]
KEYWORDS_FUTSAL = [
    "สนามฟุตซอล", "ฟุตซอล", "futsal", "อาคาร 25", "ตึก 25", "25"
]
KEYWORDS_MEETING_ROOM = [
    "ห้องประชุม", "ประชุม", "meeting room", "หอประชุม", "อาคาร 26", "ตึก 26", "26"
]
KEYWORDS_CENTRAL_PROCUREMENT = [
    "ห้องพัสดุกลาง", "พัสดุกลาง", "เบิกของกลาง", "central procurement"
]
KEYWORDS_PARKING = [
    "โรงจอดรถ", "ที่จอดรถ", "จอดรถ", "parking lot", "garage", "อาคาร 28", "ตึก 28", "28"
]
KEYWORDS_FOOTBALL = [
    "สนามฟุตบอล", "ฟุตบอล", "football field", "อาคาร 29", "ตึก 29", "29"
]
KEYWORDS_TENNIS = [
    "สนามเทนนิส", "เทนนิส", "tennis court", "อาคาร 30", "ตึก 30", "30"
]
KEYWORDS_FIXIT = [
    "ศูนย์ซ่อมสร้างชุมชน", "ซ่อมสร้างชุมชน", "fixit center", "ซ่อมเครื่องใช้","ศูนย์ซ่อม", "อาคาร 31", "ตึก 31", "31"
]
KEYWORDS_GENERAL_ADMIN = [
    "งานบริหารทั่วไป", "ธุรการ", "งานทั่วไป", "general admin", "อาคาร 24", "ตึก 24", "24"
]
KEYWORDS_INFO_DATA = [
...
KEYWORDS_ACADEMIC_TOWER = [
    "อาคารวิทยฐานะ", "วิทยฐานะ", "academic tower","สถานีวิทยุ", "อาคาร 27", "ตึก 27", "27"
]
KEYWORDS_HR = [
